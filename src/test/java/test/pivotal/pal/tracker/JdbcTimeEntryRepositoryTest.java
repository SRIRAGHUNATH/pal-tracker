...
public class JdbcTimeEntryRepositoryTest {
    ...
    public void createInsertsATimeEntryRecord() {
        TimeEntry newTimeEntry = new TimeEntry(Long.valueOf(123), Long.valueOf(321), LocalDate.parse("2017-01-09"), 8);
    ...
    public void updateReturnsTheUpdatedRecord() {
        ...
        TimeEntry timeEntryUpdates = new TimeEntry(Long.valueOf(456), Long.valueOf(987), LocalDate.parse("2017-01-10"), 10);
    ...
    public void updateUpdatesTheRecord() {
        ...
        TimeEntry updatedTimeEntry = new TimeEntry(Long.valueOf(456), Long.valueOf(322), LocalDate.parse("2017-01-10"), 10);
